...
// set the target of v, cte and epsi
double ref_v = 40;


// The start index for different variable
size_t x_start = 0;
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // for example, for variable psi, fg[1+psi_start +t] is reserved for the tth of N values of psi that the solver computer
    for (int t = 1; t < N; t++) {
